...
`registry.codeocean.com/published/e3a4fe91-41e7-4902-a8d9-62516958cdee:v1`
...
docker run --platform linux/amd64 --rm --gpus all \
  ...
  registry.codeocean.com/published/e3a4fe91-41e7-4902-a8d9-62516958cdee:v1 bash run MultiDismantler_unit_cost train
```
